...
import FormOrder from "./payment/FormOrder";
  ...
  return (
    <div>
      <div className="mt-4 mx-[109px] lg:mx-[109px] sm:mx-[40px] md:mx-[50] mb-[84px]">
        {/* Breadcrumb */}
        <div className="flex flex-row gap-2  mb-[84px]">
        ...
        <h1 className="font-bold text-black text-4xl mb-[48px]">
          Billing Details
        </h1>
        <div className="flex gap-[90px] justify-between md:flex-wrap sm:flex-wrap lg:flex-nowrap ">
          ...
          <div className="w-[553px] border rounded-lg px-[25px] py-[35px] h-fit">
            <div className="flex justify-between mb-[30px]">
              ...
              <span className="text-black text-base font-normal font-['Libre Franklin'] leading-normal">
                Rp 350.000
              </span>
            </div>
            <div className="flex justify-between mb-[30px]">
              ...
              <div className="flex flex-col items-start space-y-2">
                <label className="flex items-start space-x-2">
                  <input
                    ...
                    name="paymentMethod"
                    value="tunai"
                    className="form-radio h-5 w-5 text-black border-black checked:bg-black checked:border-black focus:ring-0"
                  />

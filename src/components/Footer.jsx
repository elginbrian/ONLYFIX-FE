        ...
        <div className="flex flex-col">
          <div className="flex gap-3 items-center">
            ...
            <div className="text-center flex items-center">
              <span className="text-[#00aef0] text-opacity-[0.95] text-[24px] font-bold font-gardenia">
                Only
              </span>
              <span className="text-[#7fd7f8] text-opacity-[0.95] text-[24px] font-bold font-gardenia">
                Fix
              </span>
            </div>
          </div>
          <p className="text-base sm:text-lg mt-4">
            Anda tukang tapi kepengen nambah-nambahin kerjaan? <br /> Gaslah
            tunggu apalagi!
          </p>
          <div className="flex flex-col">
            <div className="h-16 px-4 sm:px-6 py-2 bg-white rounded-full mt-2 flex items-center">
              <input
                type="text"
                className="text-gray-400 text-base sm:text-lg font-semibold focus:outline-none w-full"

    ...
    <div className="">
      <div className="flex flex-col lg:flex-row gap-x-[43px] items-center">
        ...
        <div className="w-full max-w-sm text-center lg:text-left">
          <h3 className="font-bold text-[#232323] text-lg sm:text-xl md:text-2xl mb-2">
            Barang Elektronik
          </h3>
          <p className="text-sm sm:text-base md:text-lg text-[#232323]">
            Berbagai macam peralatan elektronik mulai dari kulkas, laptop, hp,
            mesin cuci, hingga water heater
          </p>
        </div>
      </div>
    </div>

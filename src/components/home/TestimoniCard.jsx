    ...
    <div>
      <div className="w-[388px] h-[344px] relative">
        ...
        <div className="w-[323px] left-[32px] top-[90px] absolute text-black text-[17px] font-normal font-['Libre Franklin'] leading-[30px]">
          ...
          mauris scelerisque sed egestas pharetraol quis pharetra arcu pharetra
          blandit.”
        </div>
        <div className="left-[32px] top-[234px] absolute text-black text-xl font-bold font-['Libre Franklin'] leading-tight">
          Marni Sityaningsih
        </div>
        <div className="left-[32px] top-[266px] absolute text-[#a7a7a7] text-[17px] font-normal font-['Libre Franklin'] leading-[18px]">
          Ibu Rumah Tangga
        </div>
      </div>
    </div>
